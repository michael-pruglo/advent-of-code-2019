...
int main()
{
    ...
    Test::runAmplifierFeedbackloop(std::vector({
        std::make_pair(std::string("tests/in29.txt"), 139629729),
        std::make_pair(std::string("tests/in30.txt"), 18216),
        std::make_pair(std::string("tests/in31.txt"), 6489132)
    }));
